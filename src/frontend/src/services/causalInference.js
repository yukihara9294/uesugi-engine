 ...
 * 各要因が訪問者数に与えた効果を分解
 */
export const analyzePastData = async ({ prefecture, timeRange, currentData }) => {
  // シミュレーション用の遅延
  ...
  const decomposition = {
    ...
    factors: [
      ...
      },
      {
        name: '地域イベント',
        icon: 'event',
        effect: addNoise(5600, 0.18),
        confidence: 0.85,
        description: '花火大会による集客効果',
        details: '推定来場者3万人の大規模イベント',
      },
      {
        name: '交通アクセス改善',
        icon: 'transport',
        effect: addNoise(2100, 0.12),
        confidence: 0.90,
